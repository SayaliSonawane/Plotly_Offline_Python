...
# Define trace
trace1 =Box(y=y0,showlegend=True,marker = dict(color = 'rgb(214, 12, 140)',),name='Trace_y0')
trace2 =Box(y=y1,showlegend=True,marker = dict(color = 'rgb(0, 128, 128)',),name='Trace_y1')
...
plotly.offline.plot({
                        ...
                        "layout": Layout(title="Colored Box Chart",font=dict(family='Courier New, monospace', size=18, color='rgb(0,0,0)'))
                                  },filename='Colored_box_chart.html',image='jpeg')
